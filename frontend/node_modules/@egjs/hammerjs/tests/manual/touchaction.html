...
<div class="container">
  <p>Hammer provides a <a href="../../src/touchaction.js">kind of polyfill</a>
    for the browsers that don't support the <a href="http://www.w3.org/TR/pointerevents/#the-touch-action-css-property">touch-action</a>
    property.</p>

  <div class="green" id="native">Your browser has support for the touch-action property!</div>
  <div class="red" id="no-native">Your browser doesn't support the touch-action property,
  ...
  <p>Should <strong>not</strong> prevent any scrolling on any movement. Horizontal and vertical scrolling handled by the
    browser directly.</p>
