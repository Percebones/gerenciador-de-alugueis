 ...
 */
fun <T> RequestBuilder<T>.customize(
    `when`: Boolean,
    block: RequestBuilder<T>.() -> RequestBuilder<T>
): RequestBuilder<T> {
    if (!`when`) {
        return this
    }
 ...
 */
inline fun <T, P> RequestBuilder<T>.customize(
    value: P?,
    block: RequestBuilder<T>.(P) -> RequestBuilder<T>
): RequestBuilder<T> {
    if (value == null) {
        return this
    }
 ...
 */
inline fun <T, P1, P2> RequestBuilder<T>.customize(
    first: P1?,
    second: P2?,
    block: RequestBuilder<T>.(P1, P2) -> RequestBuilder<T>
): RequestBuilder<T> {
