    ...
    <div class="info-box-description">
        <div class="info-box-icon">
            <svg fill="none" height="26" viewBox="0 0 26 26" width="26" xmlns="http://www.w3.org/2000/svg">
                <rect fill="#E95D56" height="26" rx="4" width="26"/>
                <path d="M16 13C16 16.3137 13.3137 19 10 19C6.68629 19 4 16.3137 4 13C4 9.68629 6.68629 7 10 7C13.3137 7 16 9.68629 16 13Z"
                      fill="white" fill-opacity="0.8"/>
                <path d="M22 13C22 16.3137 19.3137 19 16 19C12.6863 19 10 16.3137 10 13C10 9.68629 12.6863 7 16 7C19.3137 7 22 9.68629 22 13Z"
                      fill="white" fill-opacity="0.8"/>
            </svg>
        </div>
...
<div class="bottom-bar">
    ...
    <a class="bottom-bar-button bottom-bar-button-dark" href="/_expo/link?choice=expo-dev-client"
       id="expo-dev-client-link">Development Build</a>
    <a class="bottom-bar-button bottom-bar-button-grey" href="/_expo/link?choice=expo-go" id="expo-go-link">Expo Go</a>
</div>
